var DATA = [
  { user: '김성현', message: '왜 필터가 되지 않는걸까?', created_at: '2019-01-03 12:30:20' },
  { user: '이준희', message: '나도 궁금한데 왜 안되는거지?', created_at: '2019-01-04 18:30:20' },
  { user: '백한나', message: '난 배우면 금방할것 같은데? 너는 왜 못하니? ㅋ 바보니?', created_at: '2019-01-05 07:30:20' },
  { user: '정원우', message: '사업이나 하자 성현아 이런거 하지 말고~', created_at: '2015-01-03 12:30:20' },
  { user: '김민수', message: '돈좀 빌려줘', created_at: '2019-01-04 18:30:20' }
];

var randomUser = ['강한나', '박보영', '이예은', '최달수', '어머니', '아버지', 'hacker', 'solution'];
var randomMessage = [
